...
pt_ArpFound
	move.w	-2(a1,d0.w*2),d2	; note period + first or second halftone addition
...
pt_SetTempo
		...
		move.b	d2,CIATALO(a5)	; counter value low bits
		lsr.w	#BYTE_SHIFT_BITS,d2 ; adjust bits
		move.b	d2,CIATAHI(a5)	; counter value high bits
		rts
		CNOP 0,4
pt_StopReplay
